                    ...
                    <div key={idx} className="grid grid-cols-7 gap-2 items-center text-xs">
                      <div className="col-span-3 flex items-center space-x-1">
                        <select
                          ...
                          className="flex-1 py-2 px-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white text-xs"
                        >
                        ...
                        <button
                          ...
                          className="px-2 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-900 dark:text-white rounded-lg text-[10px] font-bold shrink-0 transition"
                        >
                          + New
                        </button>
                      </div>
      ...
      {proofPreviewUrl && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-fade-in font-sans">
          <div className="bg-white dark:bg-[#111827] rounded-3xl w-full max-w-2xl max-h-[90vh] p-6 shadow-2xl relative border border-slate-200 dark:border-slate-800 flex flex-col space-y-4">
            ...
            <div className="flex-1 overflow-auto bg-slate-50 dark:bg-slate-900 rounded-2xl p-2 flex items-center justify-center min-h-[300px]">
